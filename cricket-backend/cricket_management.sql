...
\restrict d9YOIZ8FsfvZaDUR1B1eAeU4xbkFtsQRqGqyVqQb0dkLsa5cqLopZ4pEUFyuZq8

-- Dumped from database version 18.4
-- Dumped by pg_dump version 18.4

-- Started on 2026-07-28 19:45:28
...
--
-- TOC entry 5075 (class 0 OID 25111)
-- Dependencies: 226
...
--
-- TOC entry 5077 (class 0 OID 25133)
-- Dependencies: 228
...
--
-- TOC entry 5079 (class 0 OID 25154)
-- Dependencies: 230
-- Data for Name: match_score; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.match_score (score_id, match_id, team_id, runs, wickets, overs, striker_id, non_striker_id, current_bowler_id) FROM stdin;
1	1	1	245	6	50.0	\N	\N	\N
2	1	2	210	10	48.3	\N	\N	\N
6	3	4	0	0	0.0	\N	\N	\N
7	3	1	0	0	0.0	\N	\N	\N
8	2	3	0	0	0.0	\N	\N	\N
9	2	1	0	0	0.0	\N	\N	\N
10	36	2	31	4	1.4	\N	4	7
11	36	3	43	1	1.2	\N	7	4
\.


--
-- TOC entry 5073 (class 0 OID 25093)
-- Dependencies: 224
...
2	2026-10-02	3	1	ktm	england
3	2026-06-02	4	1	tu stadiun	nepal
36	2026-01-01	2	3	ktm	australia
\.


--
-- TOC entry 5071 (class 0 OID 25079)
-- Dependencies: 222
...
7	ron2	23	2	bowler	3
\.


--
-- TOC entry 5069 (class 0 OID 25070)
-- Dependencies: 220
...
SELECT pg_catalog.setval('public.match_score_score_id_seq', 11, true);
...
SELECT pg_catalog.setval('public.matches_match_id_seq', 36, true);
...
--
-- TOC entry 4916 (class 2606 OID 25190)
-- Name: match_score match_score_current_bowler_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.match_score
    ADD CONSTRAINT match_score_current_bowler_id_fkey FOREIGN KEY (current_bowler_id) REFERENCES public.player(player_id);


--
-- TOC entry 4917 (class 2606 OID 25164)
...
--
-- TOC entry 4918 (class 2606 OID 25185)
-- Name: match_score match_score_non_striker_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.match_score
    ADD CONSTRAINT match_score_non_striker_id_fkey FOREIGN KEY (non_striker_id) REFERENCES public.player(player_id);


--
-- TOC entry 4919 (class 2606 OID 25180)
-- Name: match_score match_score_striker_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.match_score
    ADD CONSTRAINT match_score_striker_id_fkey FOREIGN KEY (striker_id) REFERENCES public.player(player_id);


--
-- TOC entry 4920 (class 2606 OID 25169)
...
-- Completed on 2026-07-28 19:45:28

--
-- PostgreSQL database dump complete
--

\unrestrict d9YOIZ8FsfvZaDUR1B1eAeU4xbkFtsQRqGqyVqQb0dkLsa5cqLopZ4pEUFyuZq8
